...
var JwtStrategy = /** @class */ (function (_super) {
    ...
    function JwtStrategy(config, db) {
    ...
    JwtStrategy.prototype.validate = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(payload.type === types_1.user_types.doctor)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.db.doctor.findUnique({
                                where: { id: payload.id }
                            })];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.db.superAdmin.findUnique({
                            where: { id: payload.id }
                        })];
                    case 3:
                        _a = _b.sent();
